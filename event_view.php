...
<div class="item">
        ...
        <div class="invisible" id="container-<?php echo $one_event['event_id'] ?>-invisible" style="display:none;"> <!--  invisible -->
	        ...
	        <table>
	           	<tr> <!-- R # 1. -->
	 				<td style="width:25%;"><span id="evspan1" style="width:100%;text-align:center;">Izpildītāji</span></td>
	 				<td style="width:30%;"><span id="evspan1" style="width:100%;text-align:center;">Uzdevums</span></td>
	 				<td style="width:8%;"><span id="evspan1" style="width:100%;text-align:center;">Atbild.dat.</span></td>
	 				<td style="width:30%;"><span id="evspan1" style="width:100%;text-align:center;">Atbilde</span></td>
	 				<td style="width:5%;"><span id="evspan1" style="width:100%;text-align:center;">Izdevumi</span></td>
	 			</tr>
	        
	        	<?php if (strlen($one_event['teh_cilv'])>1) { ?>
	        	<tr> <!-- R #2. -->
	 				<td><span id="evspan1"> Tehniskā daļa: __</span><span id="evspan2"><?php echo $one_event['teh_cilv']; ?></span></td>
	        	...
	        	<tr> <!-- R #2. -->
	 				<td><span id="evspan1"> Laboratorija: __</span><span id="evspan2"><?php echo $one_event['lab_cilv']; ?></span></td>
