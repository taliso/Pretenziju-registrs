...
INSERT INTO `menju` VALUES (1,'Aģentu saraksts','admin.php','','Aģentu reģistrs',0,''),(2,'SP pretenzijas','pret_list.php','','Sendvičpaneļu pretenziju reģistrs',3,'SP'),(6,'Dekoru pretenzijas','pret_list.php','','Dekoru pretenziju reģistrs',1,'DE'),(3,'EPS pretenzijas','pret_list.php','','EPS pretenziju reģistrs',2,'EP'),(7,'DP pretenzija','pret_list.php','','Dobeles Paneļa pretenzija',0,'DP'),(8,'PU pretenzija','pret_list.php','','PU paneļu pretenzija',0,'PU'),(9,'PIR pretenzijas','pret_list.php',' ','PIR paneļu pretenzijas',0,'PI');
