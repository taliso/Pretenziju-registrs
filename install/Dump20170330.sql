...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Notikumi pec pretenzijas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `personas_notikums` (
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Personas iesaistiitas notikumaa';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `pretenzijas` (
  ...
  `file_obl_doc` varchar(145) DEFAULT '',
  ...
  PRIMARY KEY (`ID`),
  UNIQUE KEY `ID_UNIQUE` (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='Pretenziju registrs';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tmp_files` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='Pagaidu tabula, pievienojamo failu uzkrāšanai';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tmp_personas_notikums` (
  ...
  `e_pasts` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='Pagaidu fails datu uzkrāšanai jaunam notikumam';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2017-03-30 23:47:23
